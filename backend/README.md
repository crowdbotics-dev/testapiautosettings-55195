...
## Project Structure
    ...
    ├── testapiautosettings_55195  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_55195`
...
2. Clone this repo and `cd testapiautosettings_55195`
